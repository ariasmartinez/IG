...
class CilindroRelleno : public MallaRevol{
   public:

   CilindroRelleno(int num_verts_per, const unsigned nperfiles);
};

class SemiEsfera : public MallaRevol{
   public:

   SemiEsfera(int num_verts_per, const unsigned nperfiles);
   void colorearSemiEsfera();
};
