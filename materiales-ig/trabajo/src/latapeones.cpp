...
LataTapaSup::LataTapaSup(){
    ...
    agregar(new MallaRevolPLY("../recursos/plys/lata-psup.ply", 200));
    ponerNombre("Tapa superior de la lata");
}

LataTapaInf::LataTapaInf(){
    agregar( new Material(0.6,0.6,1.0,100) ); //DUDA
    agregar(new MallaRevolPLY("../recursos/plys/lata-pinf.ply", 200));
    ponerNombre("Tapa inferior de la lata");
}

Peon::Peon(){
    agregar(new MallaRevolPLY("../recursos/plys/peon", 200));
}
